...
- [ ] Der Code ist in deinem Fork committed
- [ ] Die Funktion ist manuell getestet (Browser)
- [ ] Es gibt keine roten Fehler in der Konsole
- [ ] Du verstehst, **warum** der Code funktioniert (nicht nur,
      **dass** er funktioniert)

Mehr dazu: [Definition of Done](../projekt/definition-of-done.md)

!!! success "Das Wichtigste"
    Es geht nicht um Perfektion. Es geht darum, dass du am Ende
    der Woche eine **funktionierende App** hast und **weist, wie du
    sie gebaut hast**.

    Du bist der einzige, der deine App braucht. Kein Team,
    kein Code-Review – nur du und dein Trainer.
