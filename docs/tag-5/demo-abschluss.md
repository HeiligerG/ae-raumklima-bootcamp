...
Ruhig bleiben. "Live-Systeme sind live. Hier ist ein Backup-Video
von gestern." Backup-Video zeigen, fertig.

## :material-video: Abschluss-Video

Am Ende des Tages nimmt der Trainer ein kurzes Video auf:

- Reihum sagt jede/r 30 Sekunden was:
    - "Was war dein Lieblingsmoment?"
    - "Was hast du gelernt, das du nicht mehr vergisst?"
- Das Video wird ins Bootcamp-Archiv aufgenommen

## Reflexion am Ende

Nimm dir 5 Minuten nach der Demo für eine **persönliche Reflexion**:

- Was hat diese Woche am meisten Spass gemacht?
- Worauf bin ich stolz?
- Was hätte ich gerne früher gewusst?
- Welche Fähigkeit will ich als nächstes lernen?

!!! success "Du hast es geschafft!"
    Du hast eine funktionierende Web-App gebaut, mit Live-Daten
    aus einer echten Sensor-Plattform, allein, mit W3Schools und
    ohne KI. Das ist nicht selbstverständlich.

    Geniess die Grill Party. Du hast es dir verdient.