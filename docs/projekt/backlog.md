...
- :material-star: Raumname, Temperatur und Luftfeuchtigkeit als Platzhalter anzeigen
...
- :material-star: App mit Mock-Daten oder API verbinden
- :material-star: Admin-Seite: Räume auswählen oder Grenzwerte anpassen
...
- :material-star-outline: LocalStorage für gespeicherte Einstellungen
